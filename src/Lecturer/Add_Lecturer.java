...
public class Add_Lecturer {
	...
	private void initialize() {
		...
		frame.setTitle("Add New Lecturer");
		...
		JLabel lblNewLabel_1 = new JLabel("Add New Lecturer");
