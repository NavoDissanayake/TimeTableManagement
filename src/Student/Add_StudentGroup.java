...
public class Add_StudentGroup {
	...
	private void initialize() {
		...
		Ysem.setModel(new DefaultComboBoxModel(new String[] {"----select YrSem----", "Y1.S1", "Y1.S2", "Y2.S1", "Y2.S2", "Y3.S1", "Y3.S2", "Y4.S1", "Y4.S2"}));
		...
		programme.setModel(new DefaultComboBoxModel(new String[] {"---select Program---", "IT", "CSSE", "IM", "CSE", "DS", "SE", "ISE"}));
