...
public class Manage_studentGroup {
	...
	private void initialize() {
		...
		frmAddStudentGroup.setBounds(350, 90, 1350, 700);
		...
		panel_4.setBounds(142, 278, 853, 251);
		panel_3.add(panel_4);
		...
		textField.setBounds(625, 106, 174, 23);
		...
		spinner.setBounds(146, 204, 161, 23);
		panel_4.add(spinner);
		
		JSpinner spinner_1 = new JSpinner();
		spinner_1.setBounds(146, 157, 161, 23);
